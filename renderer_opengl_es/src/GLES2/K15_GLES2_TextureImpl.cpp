...
namespace K15_Engine { namespace Rendering { namespace GLES2 {
	...
	const GLuint TextureImpl::GLFormatConverter[RendererBase::PF_COUNT] = {
		...
		GL_NONE,	//PF_RGBA_8_I
		GL_NONE, //PF_RGBA_8_U
		GL_NONE,	//PF_RGBA_16_I
		GL_NONE,//PF_RGBA_16_U
		GL_NONE, //PF_RGBA_16_F
		GL_NONE, //PF_RGBA_32_I
		GL_NONE,//PF_RGBA_32_U
		GL_NONE,  //PF_RGBA_32_F,

		GL_NONE, //PF_RGBA_4_DXT1
		GL_NONE, //PF_RGBA_8_DXT3
		GL_NONE  //PF_RGBA_8_DXT5
	};//GLFormatConverter
	/*********************************************************************************/
	...
	bool TextureImpl::loadRawData(byte* p_Data, Enum p_Format, uint32 p_Width, uint32 p_Height, uint32 p_Depth, bool p_CreateMipMaps)
	{
		...
		if(target == GL_TEXTURE_2D)
		{
			...
			glTexImage2D(target,0,internalFormat,p_Width,p_Height,0,format,type,0);

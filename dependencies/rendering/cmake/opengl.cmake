...
if (${RENDERER_FOUND})
	...
	elseif(${K15_PLATFORM} STREQUAL "Android")
		set(PLATFORM_RENDERER_INC ./include/OpenGL/EGL/K15_RenderEGLContext.h)
		set(PLATFORM_RENDERER_SRC ./src/OpenGL/EGL/K15_RenderEGLContext.cpp)
	...
	if (${K15_RENDERER_VERSION} STREQUAL "2")
		set(RENDERER_SRC 	./src/OpenGL/GL2/K15_RenderGL2Context.cpp
		   					./src/OpenGL/GL2/K15_RenderGL2Types.cpp)

		set(RENDERER_INC 	./include/OpenGL/K15_RenderGLContext.h
		   					./include/OpenGL/K15_RenderGLTypes.h)
	elseif (${K15_RENDERER_VERSION} STREQUAL "3")
		set(RENDERER_SRC 	./src/OpenGL/GL3/K15_RenderGL3Context.cpp

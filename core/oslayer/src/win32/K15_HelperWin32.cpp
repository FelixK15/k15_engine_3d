...
{
	int charactersConverted = MultiByteToWideChar(CP_ACP, 0, p_String, -1, p_OutputString, p_StringLength);
...
{
	int charactersConverted = WideCharToMultiByte(CP_ACP, 0, p_String, -1, p_OutputString, p_StringLength, 0, 0);

...
/*********************************************************************************/
intern void* K15_InternalMallocWrapper(size_t p_SizeInBytes, void* p_UserData)
{
	return ::malloc(p_SizeInBytes);
}
/*********************************************************************************/
intern void K15_InternalFreeWrapper(void* p_Pointer, void* p_UserData)
{
	::free(p_Pointer);
}
/*********************************************************************************/
...
{
	K15_ASSERT_TEXT(p_CustomMallocFnc, "Custom Malloc is NULL.");
	K15_ASSERT_TEXT(p_CustomFreeFnc, "Custom Free is NULL.");
...
{
	K15_ASSERT_TEXT(p_MemoryAllocator, "Custom Memory Allocator is NULL.");
	K15_ASSERT_TEXT(p_SizeInBytes, "Size for memory allocation is 0.");
...
{
	K15_ASSERT_TEXT(p_MemoryAllocator, "Custom Memory Allocator is NULL.");
	K15_ASSERT_TEXT(p_Pointer, "Memory pointer is NULL.");

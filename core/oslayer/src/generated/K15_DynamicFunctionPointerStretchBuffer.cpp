...
unsigned char K15_PopDynamicFunctionPointerElement(K15_DynamicFunctionPointerStretchBuffer* p_StretchBuffer, K15_DynamicFunctionPointer p_Element)
{
	...
	{		
		...
		{
			K15_PopDynamicFunctionPointer(p_StretchBuffer, elementIndex);
			returnValue = 1;
			break;
		}
	}
...
/*********************************************************************************/
K15_DynamicFunctionPointer* K15_GetDynamicFunctionPointerElementConditional(K15_DynamicFunctionPointerStretchBuffer* p_StretchBuffer, K15_DynamicFunctionPointerConditionFnc p_ConditionFnc, void* p_UserData)
{
	K15_ASSERT_TEXT(p_StretchBuffer, "Stretch Buffer is NULL.");
	K15_ASSERT_TEXT(p_StretchBuffer->elements, "Stretch Buffer has not yet been created.");

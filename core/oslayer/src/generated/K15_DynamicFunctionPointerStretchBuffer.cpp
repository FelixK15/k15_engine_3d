...
void K15_CreateDynamicFunctionPointerStretchBufferWithPreallocatedMemory(K15_DynamicFunctionPointerStretchBuffer* p_StretchBuffer, unsigned char* p_Buffer, unsigned int p_BufferCapacityInByte)
{
	...
	unsigned int numCapacity = p_BufferCapacityInByte / sizeof(K15_DynamicFunctionPointer);

	K15_ASSERT_TEXT(numCapacity != 0, "Byte count '%d' is less than one element of type %s (%d byte(s)).", p_BufferCapacityInByte, "K15_DynamicFunctionPointer", sizeof(K15_DynamicFunctionPointer));

	K15_DynamicFunctionPointer* elements = (K15_DynamicFunctionPointer*)p_Buffer;
...
/*********************************************************************************/
void K15_CreateDynamicFunctionPointerStretchBuffer(K15_DynamicFunctionPointerStretchBuffer* p_StretchBuffer, unsigned int p_Capacity)
{
	K15_ASSERT_TEXT(p_Capacity != 0, "Can not reserve 0 elements.");
	K15_ASSERT_TEXT(!p_StretchBuffer->elements, "Stretch Buffer has already been created.");

	unsigned int bytesToAllocate = p_Capacity * sizeof(K15_DynamicFunctionPointer);
	K15_DynamicFunctionPointer* elements = (K15_DynamicFunctionPointer*)K15_OS_MALLOC(bytesToAllocate);
...
void K15_ResizeDynamicFunctionPointerStretchBuffer(K15_DynamicFunctionPointerStretchBuffer* p_StretchBuffer, unsigned int p_Capacity)
{
	...
	{
		unsigned int newSizeInBytes = sizeof(K15_DynamicFunctionPointer) * p_Capacity;
		...
		K15_DynamicFunctionPointer* newMemory = (K15_DynamicFunctionPointer*)K15_OS_MALLOC(newSizeInBytes);

...
void K15_CreateDirectoryWatchEntryStretchBufferWithCustomAllocator(K15_DirectoryWatchEntryStretchBuffer* p_StretchBuffer, K15_CustomMemoryAllocator* p_MemoryAllocator, unsigned int p_ElementCapacity)
{
	...
	unsigned int bytesToAllocate = p_ElementCapacity * sizeof(K15_DirectoryWatchEntry);
	
	K15_DirectoryWatchEntry* elements = (K15_DirectoryWatchEntry*)K15_AllocateFromMemoryAllocator(p_MemoryAllocator, bytesToAllocate);
...
/*********************************************************************************/
void K15_CreateDirectoryWatchEntryStretchBuffer(K15_DirectoryWatchEntryStretchBuffer* p_StretchBuffer, unsigned int p_ElementCapacity)
{
	K15_CreateDirectoryWatchEntryStretchBufferWithCustomAllocator(p_StretchBuffer, K15_CreateDefaultMemoryAllocator("DirectoryWatchEntry Default Stretch Buffer Allocator"), p_ElementCapacity);
}
/*********************************************************************************/
...
void K15_ResizeDirectoryWatchEntryStretchBuffer(K15_DirectoryWatchEntryStretchBuffer* p_StretchBuffer, unsigned int p_ElementCapacity)
{
	...
	{
		unsigned int newSizeInBytes = sizeof(K15_DirectoryWatchEntry) * p_ElementCapacity;
		...
		K15_DirectoryWatchEntry* newMemory = (K15_DirectoryWatchEntry*)K15_AllocateFromMemoryAllocator(memoryAllocator, newSizeInBytes);

...
void K15_GetFontCharacterInfo(K15_RenderFontDesc* p_RenderFontDesc, const char* p_Text, uint32 p_TextLength, uint32 p_CharacterIndex, float* p_GlyphX, float* p_GlyphY, float* p_GlyphWidth, float* p_GlyphHeight, float* p_AdvanceX, float* p_AdvanceY, float* p_OffsetTop, bool8* p_Renderable);
...
uint32 K15_GetTextVertexCount(K15_RenderFontDesc* p_RenderFontDesc, const char* p_Text, uint32 p_TextLengths);

/*********************************************************************************/
intern uint8 K15_GLDrawFullscreenQuad(K15_RenderBackEnd* p_RenderBackEnd, K15_RenderResourceHandle* p_RenderProgramHandle)
{
	//TODO
...
/*********************************************************************************/
intern inline uint8 K15_GLDrawIndexed(K15_RenderBackEnd* p_RenderBackEnd, uint32 p_IndexCount, uint32 p_IndexOffset)
{
...
/*********************************************************************************/
intern uint8 K15_GLDrawMeshDesc(K15_RenderBackEnd* p_RenderBackEnd, K15_RenderResourceHandle* p_RenderMeshDesc)
{

/*********************************************************************************/
intern inline uint8 K15_GLCreateRenderTarget(K15_RenderBackEnd* p_RenderBackEnd, K15_RenderTargetDesc* p_RenderTargetDesc, K15_RenderResourceHandle* p_RenderTargetHandle)
{
	...
	//TODO
// 	uint32 activeViewport = p_RenderBackEnd->sta
...
/*********************************************************************************/
intern inline uint8 K15_GLBindRenderTarget(K15_RenderBackEnd* p_RenderBackEnd, K15_RenderResourceHandle* p_RenderTargetHandle)
{
	K15_GLRenderContext* glContext = (K15_GLRenderContext*)p_RenderBackEnd->specificRenderPlatform;

	K15_GLRenderTarget* glRenderTargetStruct = &glContext->extensions.framebuffer_object.renderTargets[*p_RenderTargetHandle];
	...
	glContext->extensions.framebuffer_object.frameBufferHandle = glFramebufferHandle;

	return K15_SUCCESS;
}
/*********************************************************************************/
intern inline uint8 K15_GLUnbindRenderTarget(K15_RenderBackEnd* p_RenderBackEnd)
{
	K15_GLRenderContext* glContext = (K15_GLRenderContext*)p_RenderBackEnd->specificRenderPlatform;

	K15_OPENGL_CALL(kglBindFramebuffer(GL_FRAMEBUFFER, 0));

	glContext->extensions.framebuffer_object.frameBufferHandle = 0;

	return K15_SUCCESS;
}
/*********************************************************************************/
intern inline uint8 K15_GLDeleteRenderTarget(K15_RenderBackEnd* p_RenderBackEnd, K15_RenderResourceHandle* p_RenderTargetHandle)
{
	K15_GLRenderContext* glContext = (K15_GLRenderContext*)p_RenderBackEnd->specificRenderPlatform;
	...
	if (glContext->extensions.framebuffer_object.frameBufferHandle == glFramebufferHandle)
	{
		//unbind
		K15_OPENGL_CALL(kglBindFramebuffer(GL_FRAMEBUFFER, 0));
		glContext->extensions.framebuffer_object.frameBufferHandle = 0;

...
/*********************************************************************************/
intern void* K15_InternalMemoryBufferAllocation(size_t p_SizeInBytes, void* p_MemoryBuffer)
{
...
/*********************************************************************************/
intern void K15_InternalMemoryBufferFree(void* p_Pointer, void* p_MemoryBuffer)
{
}
/*********************************************************************************/
...
{
	K15_ASSERT_TEXT(p_CustomMemoryAllocator, "Custom Memory Allocatr is NULL.");
	K15_ASSERT_TEXT(p_SizeInBytes > 0, "Memory Buffer size is 0.");

...
#define K15_MAX_DELTA_TIME_SAMPLES 1000
...
#define K15_CHECK_LAST_ACCESS_TIME

#define K15_ENABLE_FALLBACK_RESOURCES
#define K15_ENABLE_RUNTIME_RESOURCE_COMPILATION

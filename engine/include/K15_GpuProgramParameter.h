...
namespace K15_Engine { namespace Rendering {
    ...
    INLINE Enum getParameterType() const;
    INLINE uint32 getParameterSize() const;
		INLINE const String& getParameterName() const;

    INLINE void setParameterSize(uint32 p_Size);
		INLINE void setParameterName(const String& p_Name);
    INLINE void setParameterType(Enum p_VariableType);
